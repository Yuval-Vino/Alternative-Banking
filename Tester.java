...
public class Tester {
    ...
    Person p4=new Person("p4",1500);
        Bank bank=new Bank();
        bank.createLoan("Hagiga",p1,"Renovate",500,5,1,0.10);
      ...
      //  bank.createLoan("Hagiga",p4,"Renovate",500,5,1,0.10);
       ...
       for (int i=0;i<7;i++)
       {
           for(Loan curr : bank.pending) {
               System.out.println("Pendings day number #" + bank.time.time);
               System.out.println(curr);
           }
        /*for(Loan curr : bank.active) {
            System.out.println("Actives day number #" + bank.time.time);
            System.out.println(curr);
        }
           for(Loan curr : bank.finished) {
               System.out.println("finished day number #" + bank.time.time);
               System.out.println(curr);
           }*/
